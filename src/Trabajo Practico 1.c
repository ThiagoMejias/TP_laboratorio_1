...
int main(void) {
	...
	do {
		...
		case 4:
			...
			if (resultadoFactorizacionUno == 0) {
				printf(
						" el factorial de %2.f no pudo sacarse debido a que solo se puede sacar el factorial de un numero positivo y entero\n",
						numeroUno);
			} else {
				printf("el factorial de %.2f es: %d\n", numeroUno,
						resultadoFactorizacionUno);
			}
			if (resultadoFactorizacionDos == 0) {
				printf(
